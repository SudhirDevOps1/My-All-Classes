...
const QuickStats: React.FC<QuickStatsProps> = ({ data, streak }) => {
  ...
  const cards = [
    ...
    },
    {
      ...
      label: streak && streak > 0 ? "Streak" : "Sessions",
      value: streak && streak > 0 ? `${streak} Day${streak > 1 ? 's' : ''}` : `${stats.completedSessions}/${stats.totalSessions}`,
      color: "orange"
    },
    {
