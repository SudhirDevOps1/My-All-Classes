              ...
              <div className="p-6 space-y-6">
                ...
                <div className="pt-4 border-t border-white/10 space-y-2 text-xs text-gray-500">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span>{session.manualEntry ? 'Yes' : 'No'}</span>
                  </div>
                  {session.seriesId && (
                    <div className="flex justify-between">
                      <span>Series ID</span>
                      <span className="font-mono">{session.seriesId}</span>
                    </div>
                  )}
                  {session.parentSessionId && (
                    <div className="flex justify-between">
                      <span>Parent Session ID</span>
                      <span className="font-mono">{session.parentSessionId}</span>
                    </div>
                  )}
                  {session.recurrence && (
                    <div className="flex justify-between">
                      <span>Recurrence</span>
                      <span className="font-mono">{session.recurrence}</span>
                    </div>
                  )}
                  <div className="flex justify-between">
